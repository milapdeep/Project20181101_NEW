...
function exampleSelect() {
    document.getElementById("divCORDOVA").style.display = "block";
    document.getElementById("divJAVASCRIPT").style.display = "none";
    document.getElementById("divMAILTO").style.display = "none";
    document.getElementById("divGETCALL").style.display = "none";

    if (document.getElementById("exampleSelect").value === 'CORDOVA') {
        document.getElementById("divCORDOVA").style.display = "block";
    }
    if (document.getElementById("exampleSelect").value === 'JAVASCRIPT') {
        document.getElementById("divCORDOVA").style.display = "none";
        document.getElementById("divJAVASCRIPT").style.display = "block";
    }
    if (document.getElementById("exampleSelect").value === 'MAILTO') {
        document.getElementById("divCORDOVA").style.display = "none";
        document.getElementById("divMAILTO").style.display = "block";
    }
    if (document.getElementById("exampleSelect").value === 'GETCALL') {
        document.getElementById("divCORDOVA").style.display = "none";
        document.getElementById("divGETCALL").style.display = "block";
    }
}
    ...
    $.ajax({
        ...
        success: function (respon) {
            ...
            $.each(respon.data, function (index, element) {
                tempStr += '<div style="display: inline-block; margin: 5px;"><div><img src="' + element.avatar + '" /></div><div>' + element.first_name + ' ' + element.last_name + '</div></div>';
            });
            tempStr += '';
            $("#exampleSearchList").html(tempStr);
        }
    });
}
